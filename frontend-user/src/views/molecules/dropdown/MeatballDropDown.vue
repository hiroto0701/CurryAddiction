...
<template>
  <transition name="opacity">
    <Menu
      as="div"
      class="fixed left-14 max-sm:left-3 bottom-9"
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <DropDownMenuItem
            @click="handleRouting('PostCreate')"
            label="投稿する"
            :iconComponent="PlusIcon"
          />
          <DropDownMenuItem
            @click="handleRouting('Search')"
            label="検索する"
            :iconComponent="SearchIcon"
          />
          <DropDownMenuItem
            @click="handleRouting('UserPage')"
            label="マイページ"
            :iconComponent="AvatarIcon"
          />
        </MenuItems>
      </transition>
    </Menu>

...
const menuButton = tv({
  base: 'fixed right-3 top-8 flex h-12 w-12 items-center justify-center rounded-full border border-gray-300 bg-white opacity-70 shadow-sm duration-300 hover:bg-slate-100 hover:opacity-100',
  variants: {
    visibility: {
      hidden: 'md:hidden'
    }

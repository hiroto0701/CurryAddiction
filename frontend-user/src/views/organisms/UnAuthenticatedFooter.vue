  ...
  <footer class="bg-sumi-50 mt-auto py-12">
    <div class="mx-auto w-full px-6 xs:px-7 sm:px-10 max-w-screen-lg flex flex-col gap-11 justify-between md:flex-row">
      ...
      <div class="flex flex-col gap-4">
        <RouterLink to="privacy-policy" class="font-body text-sumi-600 block w-fit">プライバシーポリシー</RouterLink>
        <a class="font-body text-sumi-600 block w-fit" href="https://forms.gle/roKqweFnKA8vMcSR9" target="_blank" rel="noopener noreferrer">お問い合わせ</a>
      </div>
    </div>
